...
本软件的水印检测、去除与添加功能**仅供合法的图像编辑与修复用途**，例如修复个人旧照片、去除自己相机添加的日期水印、研究 AI 水印技术等。

**禁止用于以下场景：**
- 未经授权下载或去除他人版权图片的水印（"盗图"）
- 伪造 AI 生成内容元数据或隐匿内容来源（"洗稿"）
- 任何侵犯他人知识产权或违反适用法律法规的行为

加水印功能仅用于验证去水印算法的正确性，不会注入任何元数据或数字签名。
