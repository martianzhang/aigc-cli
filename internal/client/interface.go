...
type APIClient interface {
	...
	OpenLuxVideoSubmit(req *types.VideoGenerateRequest) (*types.OpenLuxVideoCreateResponse, error)
	OpenLuxVideoQuery(taskID string) (*types.OpenLuxVideoQueryResponse, error)
