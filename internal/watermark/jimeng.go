...
func init() {
	...
	// Alpha map is 414×118 at 2048px native (square) width.
	// For non-square images, the watermark scales with the SHORTER dimension
	// (same rendering pipeline as Doubao — both are ByteDance products).
	// Parameters from the remove-ai-watermarks reference project.
	const (
		nativeW     = 2048
		alphaW      = 414
		alphaH      = 118
